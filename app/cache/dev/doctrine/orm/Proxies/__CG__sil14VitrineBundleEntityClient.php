...
namespace Proxies\__CG__\sil14\VitrineBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Client extends \sil14\VitrineBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'mail', 'products', 'commands', 'commande', 'commandes');
        }
    ...
    public function addCommand(\sil14\VitrineBundle\Entity\Commande $commands)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addCommand', array($commands));

        return parent::addCommand($commands);
    }
    ...
    public function removeCommand(\sil14\VitrineBundle\Entity\Commande $commands)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeCommand', array($commands));

        return parent::removeCommand($commands);
    }
