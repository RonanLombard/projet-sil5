...
use sil14\VitrineBundle\Form\CommandeType;
...
class CommandeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('sil14VitrineBundle:Commande')->findAll();

        return $this->render('sil14VitrineBundle:Commande:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('sil14VitrineBundle:Commande:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('sil14VitrineBundle:Commande')->find($id);
        ...
        return $this->render('sil14VitrineBundle:Commande:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('sil14VitrineBundle:Commande:edit.html.twig', array(
            'entity'      => $entity,
